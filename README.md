...
[![Gemini AI](https://img.shields.io/badge/Gemini%20AI-orange?style=for-the-badge&logo=google-gemini&logoColor=white)](https://ai.google.dev/)
[![Docker](https://img.shields.io/badge/Docker-2496ED?style=for-the-badge&logo=docker&logoColor=white)](https://www.docker.com/)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg?style=for-the-badge)](LICENSE)

<br/>

> **El-Mostawsaf** (Arabic: *The Dispensary*) is a production-grade, AI-driven healthcare ecosystem that unifies Electronic Medical Records, real-time IoT vital monitoring, and multimodal clinical AI into one seamless platform — built specifically to address the challenges of Egypt's healthcare system.

**[View Repository](https://github.com/A_235_s/El-Mostawsaf) · [Report Bug](https://github.com/A_235_s/El-Mostawsaf/issues) · [Request Feature](https://github.com/A_235_s/El-Mostawsaf/issues)**
...
**El-Mostawsaf** is our answer — a unified, intelligent healthcare fabric that connects patients, physicians, and administrators through one integrated platform.

![El-Mostawsaf Ecosystem Overview](docs/images/ecosystem-overview.png)

---

## 🚨 The Problem We Solve

![Gaps Addressed by El-Mostawsaf](docs/images/gaps-addressed.png)
...
| **Specialist Access Gap** | 3–6 month waiting periods; zero rural access | AI-assisted triage + integrated telemedicine |
| **No Continuous Monitoring** | Chronic crises go undetected between visits | Real-time IoT vital monitoring with anomaly alerts |
| **Language Barrier in AI** | No colloquial Egyptian Arabic medical AI | RAG chatbot trained on 136,000 Arabic Q&A pairs |
| **Delayed Emergency Response** | Critical patient data unreachable in emergencies | Emergency SOS with live location + medical profile |
...
![El-Mostawsaf Objectives](docs/images/objectives-diagram.png)

### Complete High-Level Architecture

![High-Level Architecture Diagram](docs/images/architecture-complete.png)

### System Integration

![System Integration Diagram](docs/images/system-integration.png)
...
![Project Phases](docs/images/project-phases.png)
...
Built with **Clean Architecture** (Presentation / Domain / Data layers) and the **MVC** pattern.

![Mobile App Screens](docs/images/mobile-app-screens.png)

![Mobile Architecture Layers](docs/images/mobile-architecture-layers.png)

**Key Capabilities:**
- Secure registration and biometric authentication with encrypted local storage
- Personal Electronic Health Record (EHR) — medical history, allergies, prescriptions, chronic diseases
- Upload and OCR-scan lab reports; upload radiology images for AI analysis
...
- Smart booking and referral system — AI suggests specialty and books closest clinic
- Integrated telemedicine: video consultations without leaving the app
- Emergency SOS mode — shares live location and summarized medical profile with nearest hospital
...
![Web Landing Page](docs/images/web-landing-page.png)

#### Doctor Dashboard (Dark Mode)

![Doctor Dashboard](docs/images/doctor-dashboard.png)

**Key Capabilities:**
- Personalized dashboard with daily KPIs: Today's Appointments, Upcoming, Completed
...
- Full appointment management with filtering, booking, and status control

---

### 🛡️ 3. Admin Portal

![Admin Portal — Users Management](docs/images/admin-portal-users.png)
...
- System settings: toggle Telemedicine, toggle Maintenance Mode, view API status
...
![IoT Wearable Data Flow](docs/images/iot-wearable-flow.png)
...
- Automatic synchronization with the Flutter app
- Alerts dispatched simultaneously to patient (mobile) and physician (dashboard)

---

## 🧠 AI & Machine Learning Engine

### Multimodal AI Data Flow

![AI Multimodal Processing Flow](docs/images/ai-multimodal-flow.png)
...
![AI Chatbot Arabic Interface](docs/images/ai-chatbot-arabic.png)

![AI Chatbot Conversation](docs/images/ai-chatbot-interface.png)
...
| **Knowledge Base** | 136,000 balanced Arabic medical Q&A pairs scraped from Altibbi |
| **Coverage** | 20 medical specialties, 6,800 records each |
| **Language** | Colloquial Egyptian Arabic with full preprocessing pipeline |
...
- **Lab RAG Pipeline** — interprets uploaded test results against a structured laboratory knowledge base
...
![Burn Severity Classification in Action](docs/images/burn-classification.png)
...
![Modal Labs Serverless Deployment](docs/images/modal-deployment.png)

### 4. RESTful API Endpoints

![API Endpoints — Wearable & Patient](docs/images/api-endpoints.png)
...
| MedGemma-4B vs. base Gemma-3 4B | Clinical Benchmark Improvement | Consistent gains across all domains |
| Arabic Medical Chatbot (RAG) | NLG Evaluation (BLEU / ROUGE) | Reported in thesis §5.5.11 |
| Arabic Knowledge Base | Q&A Pairs | **136,000** across 20 specialties |
...
> *Submitted as partial fulfillment of the requirements of the degree of Bachelor of Science in Electrical Engineering (Computer & Communication Systems Engineering)*
...
- **Offline AI** — TensorFlow Lite on-device models for basic analysis without internet
...
- **Medication Reminder System** — Intelligent notification engine for adherence
- **Family Health Sharing** — Caregiver accounts for remote family monitoring
- **Prescription Module** — Digital prescriptions linked to appointments
...
[![GitHub Stars](https://img.shields.io/github/stars/A_235_s/El-Mostawsaf?style=social)](https://github.com/A_235_s/El-Mostawsaf)
